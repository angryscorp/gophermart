...
// AllWithdrawals provides a mock function with given fields: ctx, userID
func (_m *BalanceMock) AllWithdrawals(ctx context.Context, userID uuid.UUID) ([]model.Withdrawal, error) {
	ret := _m.Called(ctx, userID)

	if len(ret) == 0 {
		panic("no return value specified for AllWithdrawals")
	}
...
// BalanceMock_AllWithdrawals_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AllWithdrawals'
type BalanceMock_AllWithdrawals_Call struct {
	*mock.Call
}

// AllWithdrawals is a helper method to define mock.On call
//   - ctx context.Context
//   - userID uuid.UUID
func (_e *BalanceMock_Expecter) AllWithdrawals(ctx interface{}, userID interface{}) *BalanceMock_AllWithdrawals_Call {
	return &BalanceMock_AllWithdrawals_Call{Call: _e.mock.On("AllWithdrawals", ctx, userID)}
}

func (_c *BalanceMock_AllWithdrawals_Call) Run(run func(ctx context.Context, userID uuid.UUID)) *BalanceMock_AllWithdrawals_Call {
...
func (_c *BalanceMock_AllWithdrawals_Call) Return(_a0 []model.Withdrawal, _a1 error) *BalanceMock_AllWithdrawals_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BalanceMock_AllWithdrawals_Call) RunAndReturn(run func(context.Context, uuid.UUID) ([]model.Withdrawal, error)) *BalanceMock_AllWithdrawals_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *BalanceMock) Withdraw(ctx context.Context, userID uuid.UUID, orderNumber string, amount float64) error {
...
//   - orderNumber string
//   - amount float64
func (_e *BalanceMock_Expecter) Withdraw(ctx interface{}, userID interface{}, orderNumber interface{}, amount interface{}) *BalanceMock_Withdraw_Call {
	return &BalanceMock_Withdraw_Call{Call: _e.mock.On("Withdraw", ctx, userID, orderNumber, amount)}
}

func (_c *BalanceMock_Withdraw_Call) Run(run func(ctx context.Context, userID uuid.UUID, orderNumber string, amount float64)) *BalanceMock_Withdraw_Call {
	_c.Call.Run(func(args mock.Arguments) {
